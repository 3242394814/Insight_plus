...
local function Describe(self, context)
	...
	local regen_in = Insight.env.util.getupvalue(self.OnUpdate, "_bat_regen_time")
	local next_attack_in = Insight.env.util.getupvalue(self.OnUpdate, "_bat_attack_time")
